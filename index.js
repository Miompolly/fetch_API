...
// users.map(function (names){
//     console.log(names.avatar_url);
// avatar.innerHTML+=`<img src=${names.avatar_url} /> ${names.login}`;
...
// const fetchData=()=>{
// fetch("https://api.github.com/users").then(products=>{
//     products.json().then(product=>{
//         console.log(product);
//         product.map(item=>avatar.innerHTML+=`<img src=${item.image}/>`);
...
// console.log(users);
users.map(item=>container.innerHTML+=`
